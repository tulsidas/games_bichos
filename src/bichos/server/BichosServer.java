...
public class BichosServer {
    private static final int SERVER_PORT = 8820;

    private static final int HTTP_PORT = 8821;

    private static final int JMX_PORT = 8822;

    private static final int RMI_PORT = 8823;

    private static Logger log = LoggerFactory.getLogger(BichosServer.class);
    ...
    public static void main(String[] args) throws Throwable {
        ...
        BichosSessionHandler server = new BichosSessionHandler();
        ...
        ObjectName bean = new ObjectName(
                "BichosServer:type=BichosServiceManager");
